...
//       const bidAmount = 200;
//       await nftOffersStorage.setOfferBidFromTokenId(tokenId, bidAmount, {
//         from: addr1,
//       });
...
//     it("should set and get has bid from NFT id and address correctly", async () => {
//       await nftOffersStorage.setHasBidFromTokenId(tokenId, addr1, true, {
//         from: addr1,
//       });

//       const hasBid = await nftOffersStorage.getBidFromBidderByTokenId(tokenId, {
//         from: addr1,
//       });
//       assert.isTrue(hasBid, "The stored hasBid should be true");
//     });
...
//     it("should set and get pending withdrawals correctly", async () => {
//       const amount = 100;
//       await nftOffersStorage.setPendingWithdrawals(addr1, amount, {
//         from: addr1,
//       });

//       const pendingWithdrawals =
//         await nftOffersStorage.getPendingWithdrawalsByAddress(addr1, {
//           from: addr1,
//         });
//       assert.equal(
//         pendingWithdrawals.toString(),
//         amount.toString(),
//         "The stored pending withdrawals should match the amount"
//       );
//     });
//   });
// });
