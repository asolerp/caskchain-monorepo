...
//   describe("addressesFromTokenId", () => {
//     it("should push address from token ID", async () => {
//       const tokenId = 1;
//       const creator = accounts[0];
//       await ccNftStorage.addAllowedAddress(creator);
//       await ccNftStorage.pushAddressFromTokenId(tokenId, creator);
//       const addresses = await ccNftStorage.getAddressFromTokenId(tokenId);
//       assert.equal(addresses[0], creator);
//     });

//     it("should pop address from token ID", async () => {
//       const tokenId = 1;
//       const creator = accounts[0];
//       await ccNftStorage.addAllowedAddress(creator);
//       await ccNftStorage.pushAddressFromTokenId(tokenId, creator);
//       await ccNftStorage.popAddressFromTokenId(tokenId);
//       const addresses = await ccNftStorage.getAddressFromTokenId(tokenId);
