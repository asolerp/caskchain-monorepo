...
export const BLOCKCHAIN_WS_URL = process.env.BLOCKCHAIN_WS_URL;
export const PRIVATE_KEY = process.env.PRIVATE_KEY;
export const PUBLIC_ADDRESS = process.env.PUBLIC_ADDRESS;
export const CCNFT_CONTRACT_ADDRESS = process.env.CCNFT_CONTRACT_ADDRESS;
export const NFT_VENDOR_CONTRACT_ADDRESS =
  process.env.NFT_VENDOR_CONTRACT_ADDRESS;
