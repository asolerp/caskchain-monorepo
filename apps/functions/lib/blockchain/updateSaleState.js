...
exports.updateSaleState = void 0;
...
exports.updateSaleState = functions.https.onRequest(async (req, res) => {
    corsHandler(req, res, async () => {
        try {
            const { tokenId, state } = req.body;
            (0, logger_1.log)("TokenId:", tokenId);
            (0, logger_1.log)("State:", state);
            const nftVendor = (0, web3_1.getContract)(constants_1.NFT_VENDOR_CONTRACT_ADDRESS, NFTVendor_json_1.default.abi, wallet);
            const gasEstimateUpdateState = await nftVendor.updateStateForSale.estimateGas(tokenId, state);
            (0, logger_1.log)("Gas estimate updateState:", BigInt(gasEstimateUpdateState));
