...
exports.getJWT = functions
    .region(constants_1.REGION)
    .https.onRequest(async (req, res) => {
    corsHandler(req, res, async () => {
        try {
            const { address, signature } = req.query;
            if (!(0, utils_1.isValidEthAddress)(address) || !signature) {
            ...
            const validSignature = (0, utils_1.isValidSignature)(address, signature, messageToSign);
            if (!validSignature) {
